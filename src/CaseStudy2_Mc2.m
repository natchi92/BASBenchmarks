...
Ac      = zeros(2);
Ac(1,1) = -(1/(Zone1.Rn*Zone1.Cz))-Materials.air.Cpa*m1/Zone1.Cz - (Pout1*Radiator.alpha2)/Zone1.Cz;
Ac(1,2) = 1/(Zone1.Rn*Zone1.Cz);

Ac(2,1) = 1/(Zone1.Rn*Zone1.Cn);
Ac(2,2) = -(2/(Zone1.Rn*Zone1.Cn))-(1/(Zone1.Rout*Zone1.Cn)) - (AHU.rw.alpha3)/Zone1.Cn;             
...
Fc(1,4) = (Pout1*Radiator.alpha1 + Zone1.zeta)/Zone1.Cz;

Fc(2,1) = Zone1.alpha*Zone1.A_w*Zone1.iota/(Zone1.Cn) + 1/(Zone1.Rout*Zone1.Cn);
Fc(2,4) = Zone1.alpha*Zone1.A_w*Zone1.gamma/(Zone1.Cn) + (AHU.rw.alpha3*Trwass)/Zone1.Cn;
...
Tz1_y      = runModel(Z1m,[ 20 18  ]', Tsa,D,T);
