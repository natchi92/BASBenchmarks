...
Radiator.w_r        = 1/60;                                                   % Nominal rate of water flow [m3/min]
...
%--------- Zone Parameters    -------%
%--------- Zone 1             -------%
Zone1.Cz   =  11.3978;                                                       % Thermal capacitance of zone [J/kgK]
Zone1.Cn   =  36.3759;                                                       % Thermal capacitance of neighbouring wall [J/kgK]
Zone1.Rout =  10.3546;                                                       % Resistance of walls connected to outside [K/W]
Zone1.Rn   =  7.5898;                                                        % Resistance of walls connected to neighbouring wall [K/W]
...
%--------- Zone 2             -------%
Zone2.Cz   =  10.7311;                                                       % Thermal capacitance of zone [J/kgK]
Zone2.Cn   =  33.3759;                                                       % Thermal capacitance of neighbouring wall [J/kgK]
Zone2.Rout =  9.45;                                                          % Resistance of walls connected to outside [K/W]
Zone2.Rn   =  8.9760;                                                         % Resistance of walls connected to neighbouring wall [K/W]
